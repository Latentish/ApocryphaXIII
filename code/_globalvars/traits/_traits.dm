...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_BRIGHTEYES" = TRAIT_BRIGHTEYES,
		...
		"TRAIT_BAD_DRIVER" = TRAIT_BAD_DRIVER,
		...
		"TRAIT_CORAX" = TRAIT_CORAX,
		"TRAIT_ORGANOVORE" = TRAIT_ORGANOVORE,
		"TRAIT_HARDENED_SOLES" = TRAIT_HARDENED_SOLES,
