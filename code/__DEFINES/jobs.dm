...
#define JOB_DISPLAY_ORDER_BARKEEP 34 //Apoc Addition, remove after remap
...
#define JOB_DISPLAY_ORDER_BOGATYR_CAPTAIN 47 //APOC EDIT
#define JOB_DISPLAY_ORDER_BOGATYR 48
#define JOB_DISPLAY_ORDER_ZADRUGA 49
#define JOB_DISPLAY_ORDER_VOIVODATE 50 //APOC EDIT
#define JOB_DISPLAY_ORDER_SEPT 51
