...
/datum/controller/subsystem/job/proc/EquipRank(mob/M, rank, joined_late = FALSE)
	...
	if(job)
		...
		if((iskindred(human) && human.clan) || iscathayan(human) || isgarou(human))
			...
			if(job.title != "Prince")
				to_chat(M, span_notice("<span style='color:red;'><b>The city is in a constant state of power-struggle. While SF is a part the Anarch Freestate, the Camarilla are given foothold in the city. Whether you listen to the Baron, the Prince, the Voivodes, the Police, or none of them; you're up at night for some reason or another. At least try to act like you care about the peace.</b></span>"))
